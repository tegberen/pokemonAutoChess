...
## The BINDING_BAND
- SOOTHE_BELL: Grant the lowest HP ally 20 SHIELD every 2 seconds. Has a [50,LK]% chance to convert that ally’s remaining SHIELD into HP.
- EXP_CHARM: The holder gains 5 PP after getting hit by an attack. [50,LK]% chance to increase that PP gain by 1 after each received hit. When the holder is KO, gain 2 XP.
