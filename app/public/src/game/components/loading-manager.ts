...
export default class LoadingManager {
  ...
  async preload() {
    ...
    preloadMusic(scene, DungeonMusic.JOHN_REI_TOWN_STAGE_0)
    preloadMusic(scene, DungeonMusic.JOHN_REI_TOWN_STAGE_10)
    preloadMusic(scene, DungeonMusic.JOHN_REI_TOWN_STAGE_20)
