...
export function GamePokemonDetail(props: {
  ...
  const isEntity = (
    ...
    // "status" is a serialized schema field only present on battle entities;
    // "simulation" is server-only and never exists on client-side entities
    obj != null && typeof obj === "object" && "status" in obj
