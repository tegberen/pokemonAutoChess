...
export const ItemStats: { [item in Item]?: { [stat in Stat]?: number } } = {
  ...
  [Item.GRIP_CLAW]: { [Stat.LUCK]: 10, [Stat.CRIT_CHANCE]: 10 },
  ...
  [Item.OLD_AMBER]: {},
  [Item.DAWN_STONE]: { [Stat.AP]: 20 },
  [Item.WATER_STONE]: { [Stat.PP]: 30 },
  [Item.THUNDER_STONE]: { [Stat.SPEED]: 20 },
  [Item.FIRE_STONE]: { [Stat.ATK]: 6 },
  [Item.MOON_STONE]: { [Stat.DEF]: 6 },
  [Item.DUSK_STONE]: { [Stat.CRIT_CHANCE]: 20 },
  [Item.LEAF_STONE]: { [Stat.HP]: 30 },
  ...
  [Item.HEAVY_DUTY_BOOTS]: {[Stat.DEF]: 20, [Stat.SPEED]: -10 },
  [Item.RELIC_CROWN]: { [Stat.AP]: 10, [Stat.DEF]: 3},
  ...
  [Item.STICKY_BARB]: { [Stat.DEF]: 15, [Stat.HP]: 15 },
