export enum EffectEnum {
  ...
  PRIMORDIAL_POWER = "PRIMORDIAL_POWER",
  LARGO = "LARGO",
  ALLEGRO = "ALLEGRO",
  PRESTO = "PRESTO",
  ...
  SUBSPACE_SWELL_CHANNEL = "SUBSPACE_SWELL_CHANNEL",
  HEAVY_DUTY_BOOTS_PROC = "HEAVY_DUTY_BOOTS_PROC",
