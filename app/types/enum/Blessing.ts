...
export enum Blessing {
  ...
  CONVERGENT_PARADOX = "CONVERGENT_PARADOX",
  CRYSTAL_EXOSKELETON = "CRYSTAL_EXOSKELETON",
  BLIGHTED_GARDEN = "BLIGHTED_GARDEN",
  MONSTROUS_GLUTTONY = "MONSTROUS_GLUTTONY",
  SHEDDING_SCALES = "SHEDDING_SCALES",
  FROZEN_OCEAN = "FROZEN_OCEAN",
  MAGICAL_METAL = "MAGICAL_METAL",
  FURY_UNLEASHED = "FURY_UNLEASHED",
  HUMAN_HORROR = "HUMAN_HORROR",
...
export const SHODAN_DODGE_CHANCE = 0.1
...
export const CHAMPIONS_MASK_SHIELD_PER_FIGHTING_TIER = 40
export const CHAMPIONS_MASK_CRIT_PER_FIGHTING_TIER = 10
...
export const BERRY_GROWTH_PERMANENT_HP = 20
export const BERRY_GROWTH_GOLDEN_PERMANENT_HP = 30
...
export const GALE_WINGS_EMBERS_PER_GOLD_BY_STAR = [5, 4, 3] as const
...
export const QUEST_CRIT_POWER_TARGET = 4.5
...
export const LONE_WOLF_SPEED_DURATION = 10000
...
export const GRACIDEA_FLOWER_HEAL_MAX_HP_RATIO = 0.1
...
export const POWER_LENS_ABILITY_POWER_WHEN_HIT = 10
...
export const POKEMONOMICON_DAMAGE_BONUS = 1.4
...
export const STEAM_ENGINE_SPEED_ON_ATTACK = 5

export const SYMBIOTIC_SYMPHONY_GRASS_MAX_HP_PER_CRY = 10
export const SYMBIOTIC_SYMPHONY_SOUND_PP_PER_HEAL = 4

export const FROZEN_OCEAN_WAVE_RATIO = 0.2

export const BLIGHTED_GARDEN_POKERUS_MULCH = 1

export const FURY_UNLEASHED_RAGE_DURATION = 2000
export const FURY_UNLEASHED_RAGE_PER_WILD_TIER = 1000

export const HUMAN_HORROR_POSSESSION_DURATION = 2000
export const HUMAN_HORROR_POSSESSION_PER_HUMAN_TIER = 1000
/* indexed by HUMAN tier, so tier 0 has no entry and the possession never fires */
export const HUMAN_HORROR_ABILITIES_BY_TIER: { [tier: number]: Ability[] } = {
  1: [Ability.DISABLE, Ability.PAYDAY],
  2: [Ability.RAGE, Ability.COUNTER],
  3: [Ability.FOCUS_PUNCH, Ability.HYPER_BEAM]
}

export const CRYSTAL_EXOSKELETON_SHIELD = 50
export const CRYSTAL_EXOSKELETON_SHELL_MAX_HP_RATIO = 0.5

export const MIND_RUSH_UNOWN_GUARANTEE_TIER = 3

export const EARTHEN_BARRIER_GROUND_HOLE_BONUS = 1
export const GROUND_HOLE_ROW_STARTS = [0, 8, 16]
export const GROUND_HOLE_MAX_DEPTH = 5

export const SHEDDING_SCALES_FREE_ROLLS_PER_FLIGHT = 1
export const SHEDDING_SCALES_SCALE_SHEDDERS: Pkm[] = [
  Pkm.SALAMENCE,
  Pkm.CHARIZARD,
  Pkm.DRAGONITE,
  Pkm.DRAGAPULT
...
export const CONVERGENT_PARADOX_GENESECT_TIER = 3
export const CONVERGENT_PARADOX_UNIQUES: Pkm[] = [
  Pkm.IRON_BUNDLE,
  Pkm.IRON_MOTH,
  Pkm.IRON_HANDS,
  Pkm.IRON_THORNS,
...
export const CONVERGENT_PARADOX_LEGENDARIES: Pkm[] = [
  Pkm.IRON_VALIANT,
  Pkm.IRON_LEAVES,
  Pkm.WALKING_WAKE
]
export const CONVERGENT_PARADOX_POKEMONS: Pkm[] = [
