...
export enum Item {
  ...
  SYNCHRO_MASHINE = "SYNCHRO_MASHINE",
...
export const WeatherRocksByWeather = new Map([
  ...
  [Weather.MAGNET_STORM, Item.METAL_ALLOY],
  ...
  [Weather.DISTORTION, Item.DISTORTION_SLATE],
  [Weather.METEOR_SHOWER, Item.FOSSIL_FRAGMENT],
