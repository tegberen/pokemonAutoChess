...
export enum Transfer {
  ...
  SHOP = "SHOP",
  COOK = "COOK",
  MOUNTAIN_EGG_FEAST = "MOUNTAIN_EGG_FEAST",
  MOTHER_YARN_WOVEN = "MOTHER_YARN_WOVEN",
  DIG = "DIG",
  ...
  PARTNER_CHAT_AVAILABLE = "PARTNER_CHAT_AVAILABLE",
  PARTNER_CHAT_HISTORY = "PARTNER_CHAT_HISTORY",
  DOUBLE_UP_VICTORY = "DOUBLE_UP_VICTORY",
  FINALE_REQUEST = "FINALE_REQUEST",
  FINALE_DECLINE = "FINALE_DECLINE",
  FINALE_PROPOSAL = "FINALE_PROPOSAL",
  FINALE_DECLINED = "FINALE_DECLINED",
  FINALE_START = "FINALE_START",
  FINALE_END = "FINALE_END",
  ...
  DOUBLE_UP_REINFORCEMENT_PORTAL = "DOUBLE_UP_REINFORCEMENT_PORTAL",
  ...
  REGISTER_TOURNAMENT_TEAMS = "REGISTER_TOURNAMENT_TEAMS",
  START_TOURNAMENT = "START_TOURNAMENT",
  KICK_TOURNAMENT_PARTICIPANT = "KICK_TOURNAMENT_PARTICIPANT",
  TOURNAMENT_PARTNER = "TOURNAMENT_PARTNER",
  ADD_TOURNAMENT_TEST_PLAYERS = "ADD_TOURNAMENT_TEST_PLAYERS",
  SIMULATE_TOURNAMENT_ROUND = "SIMULATE_TOURNAMENT_ROUND",
  REPLACE_TOURNAMENT_PLAYER = "REPLACE_TOURNAMENT_PLAYER",
  START_TOURNAMENT_LOBBY = "START_TOURNAMENT_LOBBY",
  RENAME_TOURNAMENT = "RENAME_TOURNAMENT",
  SET_TOURNAMENT_WISHES = "SET_TOURNAMENT_WISHES",
  GIVE_BOOSTER = "GIVE_BOOSTER",
  SET_ROLE = "SET_ROLE",
  GIVE_TITLE = "GIVE_TITLE",
  SET_DOUBLE_UP_CHAMPION = "SET_DOUBLE_UP_CHAMPION",
  SET_SMEARGLE_SCRIBBLE_CHAMPION = "SET_SMEARGLE_SCRIBBLE_CHAMPION",
  SET_EVENT_NPC = "SET_EVENT_NPC",
  CHOICE = "CHOICE",
  ...
  GALE_WINGS_COLLECT = "GALE_WINGS_COLLECT",
