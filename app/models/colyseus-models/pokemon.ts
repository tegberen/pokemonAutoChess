...
export class Pokemon extends Schema implements IPokemon {
  ...
  @type("string") awakeningRock: string = ""
  ...
  additional = false
  /* Fossil unlocks: kept out of the pools shared with the lobby, so it is only
     ever drawn from the personal Unlock Pool of a player who earned it. Having a
     Fossil unlock condition is a separate thing: REGIGIGAS has one but is still
     findable in the regular legendary pool, so it is not unlockable. */
  unlockable = false
  regional = false
  canHoldItems = true
  ...
  canBeBenched = true
  canBeSold = true
  /* restored Galar fossils are granted on top of the board, so they do not
     spend one of the player's team slots */
  countsForTeamSize = true
...
export class Swablu extends Pokemon {
  types = new SetSchema<Synergy>([Synergy.FAIRY, Synergy.AMORPHOUS])
  rarity = Rarity.EPIC
  stars = 1
  ...
  additional = true
  passive2 = Passive.CLOUDY_WEATHER_SUPPORT
}

export class Altaria extends Pokemon {
  types = new SetSchema<Synergy>([Synergy.DRAGON, Synergy.FAIRY, Synergy.AMORPHOUS])
  rarity = Rarity.EPIC
  stars = 2
...
export class Scizor extends Pokemon {
  types = new SetSchema<Synergy>([Synergy.WILD, Synergy.BUG, Synergy.STEEL])
  rarity = Rarity.EPIC
  stars = 2
  hp = 220
  atk = 24
...
export class Kleavor extends Pokemon {
  types = new SetSchema<Synergy>([Synergy.WILD, Synergy.BUG, Synergy.ROCK])
  rarity = Rarity.EPIC
  stars = 2
  hp = 220
  atk = 22
...
export class Snover extends Pokemon {
  ...
  regional = true
  passive2 = Passive.SNOW_WEATHER_SUPPORT
...
export class MegaSlowbro extends Pokemon {
  types = new SetSchema<Synergy>([Synergy.PSYCHIC, Synergy.WATER, Synergy.ROCK])
  rarity = Rarity.UNCOMMON
  stars = 3
  hp = 180
  atk = 12
...
export class FeraligatrPirate extends Pokemon {
  types = new SetSchema<Synergy>([Synergy.WATER, Synergy.MONSTER, Synergy.DARK])
  rarity = Rarity.RARE
  stars = 3
  hp = 240
  atk = 27
...
export class Larvesta extends Pokemon {
  ...
  additional = true
  passive2 = Passive.DROUGHT_WEATHER_SUPPORT
}
...
export class Latias extends Pokemon {
  ...
  evolutionRule = {
    type: EvolutionRuleType.STATE,
    condition: (pokemon: IPokemon, player: IPlayer) => player.life <= 25
  } as const
  hp = 120
  atk = 12
  speed = 60
...
export class Mewtwo extends Pokemon {
  ...
  evolutionRule = {
    type: EvolutionRuleType.ITEM,
    itemsTriggeringEvolution: [Item.MEWTWONITE_Y]
  } as ItemEvolutionRule
  stacksRequired = 20
  stars = 3
  hp = 200
  atk = 25
...
export class Kyurem extends Pokemon {
  ...
  evolutionRule = {
    type: EvolutionRuleType.ITEM,
    itemsTriggeringEvolution: [Item.DNA_SPLICER]
  } as ItemEvolutionRule
  stars = 3
  hp = 200
  atk = 27
...
export class Celebi extends Pokemon {
  types = new SetSchema<Synergy>([Synergy.GRASS, Synergy.FAIRY, Synergy.FLORA])
  rarity = Rarity.LEGENDARY
  stars = 3
  hp = 250
  atk = 20
...
export class Primeape extends Pokemon {
  ...
  } as const satisfies StackEvolutionRule
  stacksRequired = 10
  hp = 240
  atk = 20
  speed = 54
...
export class Archen extends Pokemon {
  types = new SetSchema<Synergy>([Synergy.FOSSIL, Synergy.FLYING, Synergy.ROCK])
  rarity = Rarity.RARE
  stars = 1
...
export class Shieldon extends Pokemon {
  types = new SetSchema<Synergy>([Synergy.FOSSIL, Synergy.STEEL, Synergy.ROCK])
  rarity = Rarity.EPIC
  stars = 1
...
export class Lileep extends Pokemon {
  types = new SetSchema<Synergy>([Synergy.FOSSIL, Synergy.GRASS, Synergy.AQUATIC])
  rarity = Rarity.UNCOMMON
  stars = 1
...
export class Nincada extends Pokemon {
  ...
  additional = true
  passive2 = Passive.PLAGUE_WEATHER_SUPPORT
}
...
export class Buizel extends Pokemon {
  ...
  skill = Ability.AQUA_JET
  additional = true
  passive2 = Passive.FLOOD_WEATHER_SUPPORT
}
...
export class Galvantula extends Pokemon {
  types = new SetSchema<Synergy>([Synergy.WILD, Synergy.BUG, Synergy.ELECTRIC])
  rarity = Rarity.RARE
  stars = 2
  hp = 160
  atk = 17
...
export class GalarianMrMime extends Pokemon {
  types = new SetSchema<Synergy>([Synergy.FAIRY, Synergy.PSYCHIC, Synergy.ICE])
  rarity = Rarity.UNCOMMON
  stars = 2
  hp = 150
  atk = 11
...
export class Staraptor extends Pokemon {
  ...
  evolutionRule = {
    type: EvolutionRuleType.ITEM,
    itemsTriggeringEvolution: [Item.SAFETY_GOGGLES]
  } as ItemEvolutionRule
  hp = 200
  atk = 19
  speed = 57
...
export class Nosepass extends Pokemon {
  ...
  additional = true
  passive2 = Passive.MAGNET_STORM_WEATHER_SUPPORT
}
...
export class Weezing extends Pokemon {
  ...
  skill = Ability.SMOG
  additional = true
  passive2 = Passive.SMOG_WEATHER_SUPPORT
}
...
export class GalarianWeezing extends Pokemon {
  ...
  passive2 = Passive.MISTY_WEATHER_SUPPORT
}
...
export class Yanma extends Pokemon {
  types = new SetSchema<Synergy>([Synergy.FOSSIL, Synergy.BUG, Synergy.FLYING])
  rarity = Rarity.RARE
  stars = 1
...
export class Barboach extends Pokemon {
  ...
  additional = true
  passive2 = Passive.RAIN_WEATHER_SUPPORT
}
...
export class Misdreavus extends Pokemon {
  ...
  additional = true
  passive2 = Passive.MURKY_WEATHER_SUPPORT
}
...
export class Ducklett extends Pokemon {
  ...
  additional = true
  passive2 = Passive.WINDY_WEATHER_SUPPORT
}
...
export class Dracovish extends Pokemon {
  ...
  passive = Passive.DRACOVISH
  /* restored from two Galar fossils onto the board: it is a gift on top
     of the team, never traded, equipped or benched */
  canHoldItems = false
  canBeSold = false
  canBeBenched = false
  countsForTeamSize = false
}
...
export class Dracozolt extends Pokemon {
  ...
  maxPP = 60
  range = 1
  skill = Ability.AMPING_BEAK
  passive = Passive.DRACOZOLT
  /* restored from two Galar fossils onto the board: it is a gift on top
     of the team, never traded, equipped or benched */
  canHoldItems = false
  canBeSold = false
...
export class Arctozolt extends Pokemon {
  ...
  maxPP = 60
  range = 1
  skill = Ability.FROZEN_BEAK
  passive = Passive.ARCTOZOLT
  /* restored from two Galar fossils onto the board: it is a gift on top
     of the team, never traded, equipped or benched */
  canHoldItems = false
  canBeSold = false
...
export class Arctovish extends Pokemon {
  ...
  maxPP = 60
  range = 1
  skill = Ability.FROZEN_REND
  passive = Passive.ARCTOVISH
  /* restored from two Galar fossils onto the board: it is a gift on top
     of the team, never traded, equipped or benched */
  canHoldItems = false
  canBeSold = false
...
export class Toxel extends Pokemon {
  ...
  evolutionRule = {
    ...
    divergentEvolution: (pokemon: IPokemon, player: IPlayer) => {
      ...
      return electricCount >= poisonCount
        ? Pkm.TOXTRICITY
...
export class Lickitung extends Pokemon {
  ...
  isInRegion(map: DungeonPMDO, state?: GameState) {
    ...
    return (
      ...
      regionSynergies.includes(Synergy.GOURMET)
    )
  }
}
...
export class Ursaluna extends Pokemon {
  ...
  range = 1
  skill = Ability.FURY_SWIPES
  passive = Passive.BLOODMOON_FORM_CHANGE
  beforeSimulationStart({
    weather,
    player
  }: {
...
export class UrsalunaBloodmoon extends Pokemon {
  ...
  maxPP = 120
  range = 1
  skill = Ability.BLOODMOON_ABILITY
  beforeSimulationStart({
    weather,
    player
  }: {
...
export class Rockruff extends Pokemon {
  types = new SetSchema<Synergy>([Synergy.ROCK])
  rarity = Rarity.EPIC
  stars = 1
...
export class LycanrocDusk extends Pokemon {
  ...
  passive2 = Passive.BLOODMOON_WEATHER_SUPPORT
}
...
export class LycanrocNight extends Pokemon {
  ...
  passive2 = Passive.NIGHT_WEATHER_SUPPORT
}
...
export class LycanrocDay extends Pokemon {
  ...
  passive2 = Passive.ZENITH_WEATHER_SUPPORT
}
...
export class Wattrel extends Pokemon {
  ...
  skill = Ability.SPARK
  additional = true
  passive2 = Passive.STORM_WEATHER_SUPPORT
}
...
export class Zygarde10 extends Pokemon {
  ...
  evolutionRule = {
    type: EvolutionRuleType.STATE,
    condition: (pokemon: IPokemon, player: IPlayer) => player.life <= 20
  } as const
  atk = 26
  speed = 62
  def = 8
...
export class Inkay extends Pokemon {
  ...
  additional = true
  passive2 = Passive.ECLIPSE_WEATHER_SUPPORT
}
...
export class Elgyem extends Pokemon {
  ...
  additional = true
  passive2 = Passive.DISTORTION_WEATHER_SUPPORT
}
...
export class Skrelp extends Pokemon {
  types = new SetSchema<Synergy>([Synergy.DRAGON, Synergy.POISON, Synergy.WATER])
  rarity = Rarity.UNCOMMON
  stars = 1
...
const alcremieByFlavor: Record<(typeof Flavors)[number], Pkm> = {
  [Item.VANILLA_FLAVOR]: Pkm.ALCREMIE_VANILLA,
  [Item.RUBY_FLAVOR]: Pkm.ALCREMIE_RUBY,
  [Item.MATCHA_FLAVOR]: Pkm.ALCREMIE_MATCHA,
  [Item.MINT_FLAVOR]: Pkm.ALCREMIE_MINT,
  [Item.LEMON_FLAVOR]: Pkm.ALCREMIE_LEMON,
  [Item.SALTED_FLAVOR]: Pkm.ALCREMIE_SALTED,
  [Item.RUBY_SWIRL_FLAVOR]: Pkm.ALCREMIE_RUBY_SWIRL,
  [Item.CARAMEL_SWIRL_FLAVOR]: Pkm.ALCREMIE_CARAMEL_SWIRL,
  [Item.RAINBOW_SWIRL_FLAVOR]: Pkm.ALCREMIE_RAINBOW_SWIRL
} as const
...
export class ZacianCrowned extends Pokemon {
  types = new SetSchema<Synergy>([Synergy.WILD, Synergy.FAIRY, Synergy.STEEL])
  rarity = Rarity.LEGENDARY
  stars = 4
  hp = 260
  atk = 22
...
export class Zamazenta extends Pokemon {
  ...
  evolutionRule = {
    type: EvolutionRuleType.ITEM,
    itemsTriggeringEvolution: [Item.RUSTED_SHIELD]
  } as ItemEvolutionRule
  stars = 3
  hp = 260
  atk = 22
...
export class Wimpod extends Pokemon {
  types = new SetSchema<Synergy>([Synergy.FOSSIL, Synergy.BUG, Synergy.WATER])
  rarity = Rarity.COMMON
  stars = 1
...
export class Skiddo extends Pokemon {
  types = new SetSchema<Synergy>([Synergy.GRASS, Synergy.FIELD])
  rarity = Rarity.EPIC
  stars = 1
  evolution = Pkm.GOGOAT
  hp = 140
  atk = 8
  speed = 44
  def = 5
  ...
  maxPP = 90
  range = 1
  skill = Ability.CITY_SHUTTLE
  additional = true
  passive2 = Passive.HARD_TERRAIN_WEATHER_SUPPORT
}

export class Gogoat extends Pokemon {
  types = new SetSchema<Synergy>([Synergy.GRASS, Synergy.FIELD])
  rarity = Rarity.EPIC
  stars = 2
  hp = 300
...
export class Cetoddle extends Pokemon {
  ...
  isInRegion(map: DungeonPMDO, state?: GameState) {
    ...
    return (
      regionSynergies.includes(Synergy.ICE) ||
      regionSynergies.includes(Synergy.SOUND)
    )
  }
}
...
export class Dwebble extends Pokemon {
  ...
  isInRegion(map: DungeonPMDO, state?: GameState) {
    const regionSynergies = RegionDetails[map]?.synergies
    return (
      regionSynergies.includes(Synergy.BUG)
    )
  }
}
